<?php
	...
	function testStatisticMedian01() {
		return NumbersStatistic::median(array(0, 2, 15)) == 2;
	}
	...
	function testStatisticMedian02() {
		return NumbersStatistic::median(array(1, 0, 2)) == 1;
	}
	...
	function testStatisticMedian03() {
		return NumbersStatistic::median(array(0, 1, 2, 3)) == 1.5;
	}
	...
	function testStatisticMedian04() {
		return NumbersStatistic::median(array(1, 3, 2, 0)) == 1.5;
	}