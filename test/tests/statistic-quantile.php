<?php
	...
	function testStatisticQuantile01() {
		return NumbersStatistic::quantile(array(5, 2, 4), 0, 1) == 2;
	}
	...
	function testStatisticQuantile02() {
		return NumbersStatistic::quantile(array(5, 2, 4), 6, 6) == 5;
	}
	...
	function testStatisticQuantile03() {
		return NumbersStatistic::quantile(array(9, 1, 1, 9), 2, 4) == 5;
	}
	...
	function testStatisticQuantile04() {
		return NumbersStatistic::quantile(array(3, 6, 7, 8, 8, 9, 10, 13, 15, 16, 20), 1, 4) == 7;
	}