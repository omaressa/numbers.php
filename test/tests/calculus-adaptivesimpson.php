<?php
	...
	function testCalculusAdaptiveSimpson() {
		return NumbersPHP\Basic::numbersEqual(NumbersCalculus::adaptiveSimpson('testCalculusAdaptiveSimpsonTestFunc', 0, 100), 666666.66667, NumbersPHP\Numbers::EPSILON);
	}
