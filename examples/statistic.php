<?php
	...
	$report = NumbersStatistic::report($followers);
	...
	$correlation = NumbersStatistic::correlation($tweets, $followers);
	echo 'Correlation between tweets and followers: ' . $correlation . "\n";
	
	// Now let's create a linear regression.
	$linReg = NumbersStatistic::linearRegression($tweets, $followers);
